                                ...
                                <table class="table table-striped data-table" id="tabelaProfessores">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a href="{{ route('gradeHorarios.show', $gradeHorario->id) }}" class="btn btn-icon btn-primary" ><i class="far fa-eye"></i></a>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('gradeHorarios.destroy', $grade->horarios) }}" method="POST" style="display: inline;">
                    @csrf
                    @method('DELETE')
